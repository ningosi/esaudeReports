...
import org.openmrs.module.esaudereports.reporting.cohort.definition.ObsInLastVisitCohortDefinition;
import org.openmrs.module.esaudereports.reporting.dataset.definition.VisitsForPatientDataDefinition;
...
/**
 * Created by codehub on 6/23/17. Evaluator for {@link ObsInLastVisitCohortDefinition}
 */
...
public class ObsInLastVisitCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		// Get all last visits before the onOrBefore date
		...
		obssDef.setOnOrBefore(cd.getOnOrBefore());
