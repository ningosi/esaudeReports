 ...
 */
package org.openmrs.module.esaudereports.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.ReportingmoduleforeSaudeController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class ReportingmoduleforeSaudeController {
